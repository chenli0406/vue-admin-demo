...
export const asyncRoutes = [
    ...
    children: [
      {
        path: 'pmList',
        name: 'PmList',
        component: () => import('@/views/appUser/pm/pmList/index'),
        meta: {
          title: '项目列表',
          noKeepAlive: true,
        },
      ...
      },
      {
        path: 'contract',
        name: 'Contract',
        component: () => import('@/views/appUser/pm/contract/index'),
        meta: {
          title: '合同管理',
        },
      },
      {
        path: 'panoramicPlan',
        name: 'PanoramicPlan',
        component: () => import('@/views/appUser/pm/panoramicPlan/index'),
        meta: {
          title: '全景计划',
        },
      },
    ...
    children: [
      {
        path: 'earlyWarning',
        name: 'EarlyWarning',
        component: () => import('@/views/appUser/sysSet/earlyWarning/index'),
        meta: {
          title: '预警设置',
        },
      },
    ...
    children: [
      {
        path: 'warningInfo',
        name: 'WarningInfo',
        component: () => import('@/views/appUser/warningInfo/index'),
        meta: {
          title: '预警信息',
          icon: 'bars',
        },
    ...
    children: [
      {
        path: 'commission',
        name: 'Commission',
        component: () => import('@/views/appUser/commission/index'),
        meta: {
          title: '代办事项',
          icon: 'bell',
        },
  ...
  },
  {
    ...
    component: Layout,
    redirect: 'noRedirect',
    meta: { title: '系统公告', icon: 'mail-bulk', permissions: ['admin'] },
    children: [
      {
        path: 'systemNotice',
        name: 'SystemNotice',
        component: () => import('@/views/appUser/systemNotice/index'),
        meta: {
          title: '系统公告',
          icon: 'mail-bulk',
        },
      },
      {
        ...
        name: 'add',
        hidden: true,
        component: () => import('@/views/appUser/systemNotice/components/add'),
        meta: {
          title: '编辑系统公告',
        },
      },
    ...
    children: [
      {
        path: 'logList',
        name: 'LogList',
        component: () => import('@/views/appUser/logList/index'),
        meta: {
          title: '操作日志',
          icon: 'list-alt',
        },
